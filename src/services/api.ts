...
import type { APIEndpoint, APIRequestArgs, APIRequestOptions, APIResponse } from "@/types";
...
export class APIService {
  ...
  async request<T extends APIEndpoint>(...[path, options]: APIRequestArgs<T>): Promise<APIResponse<T>> {
  ...
  private parseRequestOptions(path: string, options?: APIRequestOptions<APIEndpoint>) {
