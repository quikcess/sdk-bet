...
export const Routes = {
  ...
  bets: {
    ...
    getById: (guildId: string,betId: string) => Route<"guilds/bets/getById">(`api/v1/guilds/${guildId}/bets/${betId}`),
    ...
    metrics: (guildId: string) => Route<"guilds/bets/metrics">(`api/v1/guilds/${guildId}/bets/metrics`),
    // fetchCount: () => Route<"bets/fetchCount">(`api/v1/bets/count`),
    count: (guildId: string) => Route<"guilds/bets/count">(`api/v1/guilds/${guildId}/bets/count`),
    bulk: {
